...
const slide = {
  ...
  description:
    "We are a passionate team dedicated to transforming ideas into impactful digital solutions. Our mission is to help businesses grow with smart and scalable IT services.",
  buttons: ["Our Mission", "Meet the Team"],
};
      ...
      >
        ...
        >
          {slide.buttons.map((btn, i) => (
            <button className="bg-white text-blue-700 hover:bg-gray-100 px-6 py-2 rounded-full transition">
              {btn}
            </button>
          ))}
        </motion.div>
